...
function print_sorted_table(title, stable, ts_s, ts_ns, timedelta, viz_info)
  ...
  if viz_info.output_format == "json" then
    ...
    for k,v in sorted_grtable do
      ...
      if viz_info.value_units == "none" then
        print(extend_string(title,EXTEND_STRING_SIZE) .. extend_string(tostring(v), EXTEND_STRING_SIZE) .. keystr)
      elseif viz_info.value_units == "bytes" then
        print(extend_string(title,EXTEND_STRING_SIZE) .. extend_string(format_bytes(v), EXTEND_STRING_SIZE) .. keystr)
      elseif viz_info.value_units == "time" then
        print(extend_string(title,EXTEND_STRING_SIZE) .. extend_string(format_time_interval(v), EXTEND_STRING_SIZE) .. keystr)
      elseif viz_info.value_units == "timepct" then
        ...
        print(extend_string(title,EXTEND_STRING_SIZE) .. extend_string(pctstr, EXTEND_STRING_SIZE) .. keystr)  
      end
    end
  end
end
